...
if __name__ == "__main__":
    ...
    initialize('192.168.1.13:3000/evospace','test_pop',5,-5,5,400)
    #time.sleep(20)
    ...
    env = { 'FUNCTION': 3, 'INSTANCE':1, 'DIM':5,'FEmax':500000,
               ...
               'UPPER_BOUND': 5, 'LOWER_BOUND': -5,  'BENCHMARK': True, 'EXPERIMENT_ID': 66,
 ...
 #              'SAMPLE_SIZE': 100, 'MAX_SAMPLES': 40, 'NGEN': 50}
  ...
  #  algs = [ (gwo_env,"python /home/EvoWorker/gwo_worker.py %s "),
   #          (ga_env, "python /home/EvoWorker/ga_worker.py %s "),
    ...
    psos = [make_container(env, "python /home/EvoWorker/pso_worker.py %s ") for _ in range(4)]
    containers = psos
    #containers = gas+psos
