...
evospace.initialize(REDIS_HOST + ':3000/evospace','test_pop',5,-5,5,EVOSPACE_SIZE)
print dw.get_containers()
dw.kill_all()
dw.remove_all()


env = {'FUNCTION': 4, 'INSTANCE': 2, 'DIM': 5, 'FEmax': 500000,
...
info = { 'workers':{'GA':{'Number':2, 'envs':[env]},'PSO':{'Number':4, 'envs':[env]}} }
